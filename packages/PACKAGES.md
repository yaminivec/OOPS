...
**\*Static can be used without creating object**

**\*Main is the first thing to run so it must run without any instance been created and Here we start with PUBLIC STATIC VOID MAIN**

**\*Any method called inside static must be static**
